...
const UpdateProduct = () => {
  ...
  const handleUpdate = async (e) => {
    ...
    try {
      ...
      token = parsedAuthData.token; // Adjust this line based on the actual structure of your auth data
    } catch (error) {
    ...
    try {
      ...
      photo && productData.append("photo", photo); // Only append photo if it exists
